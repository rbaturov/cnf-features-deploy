...
require (
	...
	github.com/openshift/cluster-nfd-operator v0.0.0-20250314134736-172721cfa8d1
...
replace (
	...
	github.com/openshift/cluster-nfd-operator => github.com/openshift/cluster-nfd-operator v0.0.0-20250314134736-172721cfa8d1 // release-4.9
