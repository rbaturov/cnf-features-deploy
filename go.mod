...
require (
	...
	github.com/openshift/cluster-node-tuning-operator 9500cb1b6702
...
replace (
	...
	github.com/openshift/cluster-node-tuning-operator => github.com/openshift/cluster-node-tuning-operator 9500cb1b6702 // release-4.14
