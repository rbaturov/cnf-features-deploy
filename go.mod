...
require (
	...
	github.com/openshift/cluster-nfd-operator v0.0.0-20251208202434-7ee083174821
...
replace (
	...
	github.com/openshift/cluster-nfd-operator => github.com/openshift/cluster-nfd-operator v0.0.0-20251208202434-7ee083174821 // release-4.9
