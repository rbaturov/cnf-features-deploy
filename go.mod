...
require (
	...
	github.com/openshift/cluster-node-tuning-operator v0.0.0-20250404134339-a63ae2504f44
...
replace (
	...
	github.com/openshift/cluster-node-tuning-operator => github.com/openshift/cluster-node-tuning-operator v0.0.0-20250404134339-a63ae2504f44 // release-4.14
