...
require (
	...
	github.com/openshift/cluster-nfd-operator v0.0.0-20250410092906-cfca6596cd1e
...
replace (
	...
	github.com/openshift/cluster-nfd-operator => github.com/openshift/cluster-nfd-operator v0.0.0-20250410092906-cfca6596cd1e // release-4.9
